...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var sixes = numbers.Where(num => num > 6);
            ...
            foreach (var item in numbers.OrderByDescending(numbers => num))
            {
                Console.WriteLine(item);
            }
            ...
            Console.WriteLine("C or S Emplyoees");
            foreach (var items in filtered)
            {
            ...
            employees.Append(new Employee("first", "lastName", 25, 1)).ToList();
